...
namespace ThePandemoniummod.NPCs            //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class AnglerCheater : ModNPC
    {
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
            switch (Main.rand.Next(4))    //this are the messages when you talk to the npc
            {
                ...
                case 1:
                    return "You can spend your time fishing or just buy the fish from me... hehe.";
                case 2:
                    return "I like this house.";
                case 3:
                    return "Meet me behind the Angler's house in about three hours. I have something I think he will find very appealing.";
                default:
        ...
        {
            scale = 1f;
            item = Main.itemTexture[mod.ItemType("StoneSword")]; //this defines the item that this npc will use
            itemSize = 56;
        }
