...
namespace ThePandemoniummod.Items
{
	public class DarkBow : ModItem
	{
		...
		{
            DisplayName.SetDefault("Dark Bow");
			Tooltip.SetDefault("The bow pulsates with dark energy.");
		}
		...
		/*public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			if (type == ProjectileID.WoodenArrowFriendly)
			{
				...
				Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians());
			...
			public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "Adhesive", 10);
