...
namespace ThePandemoniummod.Items
{
	public class MeteorBow : ModItem
	{
		...
		{
            DisplayName.SetDefault("Meteor Bow");
			Tooltip.SetDefault("You feel powerful within the first touch of the bow... For a good reason it seems.");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			float numberProjectiles = 9 + Main.rand.Next(9); // 3, 4, or 5 shots
